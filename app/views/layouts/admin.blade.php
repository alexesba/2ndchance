...
<html lang="en">
  <head>
    ...
    {{ HTML::style('packages/bootstrap/css/admin.css') }}
  ...
  <body>
    ...
    @section('scripts')
      ...
      {{ HTML::script('packages/custom/js/chart-data-morris.js') }}
      {{ HTML::script('packages/custom/js/jquery.tablesorter.js') }}
      {{ HTML::script('packages/custom/js/tables.js') }}
    @show
